import { Category, Company, Product, Coupon } from '@/types';
...
export const companies: Company[] = [
  {
    ...
    name_ar: 'الكوثر',
    name_en: 'El Kawther',
    description_ar: 'توريد منتجات مختارة بعناية للجودة اليومية.',
    description_en: 'Supplying carefully selected products for everyday quality.',
  },
  {
    id: 'faragello',
    slug: 'faragello',
    name_ar: 'فرجيلو',
    name_en: 'Faragello',
    description_ar: 'خضروات مجمدة بجودة عالية.',
    description_en: 'High-quality frozen vegetables.',
  },
  {
    id: 'halwani',
    slug: 'halwani',
    name_ar: 'حلواني',
    name_en: 'Halwani',
    description_ar: 'منتجات لحوم مجمدة جاهزة للطهي.',
    description_en: 'Frozen meat products ready to cook.',
  },
  {
    id: 'rehana',
    slug: 'rehana',
    name_ar: 'ريهانا',
    name_en: 'Rehana',
    description_ar: 'أرز مصري فاخر للاستخدام اليومي.',
    description_en: 'Premium Egyptian rice for daily meals.',
  },
  {
    id: 'regina',
    slug: 'regina',
    name_ar: 'ريجينا',
    name_en: 'Regina',
    description_ar: 'مكرونة عالية الجودة.',
    description_en: 'High quality pasta.',
  },
  {
    id: 'al-doha',
    slug: 'al-doha',
    name_ar: 'الضحى',
    name_en: 'Al Doha',
    description_ar: 'سكر أبيض ناعم للأغراض اليومية.',
    description_en: 'Fine white sugar for daily use.',
  },
  {
    id: 'crystal',
    slug: 'crystal',
    name_ar: 'كريستال',
    name_en: 'Crystal',
    description_ar: 'زيوت للقلي والاستخدام اليومي.',
    description_en: 'Cooking oils for daily use.',
  },
  {
    id: 'juhayna',
    slug: 'juhayna',
    name_ar: 'جهينة',
    name_en: 'Juhayna',
    description_ar: 'منتجات ألبان موثوقة.',
    description_en: 'Trusted dairy products.',
  },
  {
    id: 'domty',
    slug: 'domty',
    name_ar: 'دومتي',
    name_en: 'Domty',
    description_ar: 'أجبان بطعم غني.',
    description_en: 'Cheeses with a rich flavor.',
  },
];
